...
voss/harness/code/semantic_index.py (V19-02):
  CodeIndex.build()  # add enrichment call site guarded by profile+config
</interfaces>
...
<task type="auto" tdd="true">
  ...
  <acceptance_criteria>
    ...
    - `test_cost_ledger_line` passes: a `method="enrich"` row is appended to token-savings.jsonl
