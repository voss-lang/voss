...
**Current focus:** Phase 1 — Runtime Library

## Current Phase

**Phase:** 1 — Runtime Library
**Status:** Pending (not started)
**Goal:** Standalone `voss_runtime` package implementing every primitive Voss will codegen against, validated with hand-written Python.
