...
| BOS4 | Decision Ledger Runtime | Record task-to-agent, autonomy, review, validation, escalation, and no-action decisions from runtime gates | BOS-DATA-02 | schema exists; runtime replanning next |
