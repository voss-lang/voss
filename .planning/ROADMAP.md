...
> **2026-09-12 — Voss ADE moved to a separate repository.** Voss owns the
> engine, CLI, `voss serve`, the protocol, and the SDKs. The desktop
> application owns terminals, panes, canvas, layouts, and themes, and
> integrates only over the protocol. See
> `docs/architecture/0004-voss-ade-repository-split.md`. The A-track and the
> ADE-facing V-track phases below are frozen history under `archive/voss-ade/`;
> the dated log in this file is kept as a record and is not rewritten.
...
| A1–A13 | voss-app Desktop ADE (moved out) | The desktop application is a separate repository as of 2026-09-12; see `docs/architecture/0004-voss-ade-repository-split.md`. Frozen history: `archive/voss-ade/`. | — | moved |
...
The desktop application (Voss ADE) is a separate repository as of 2026-09-12.
Voss owns the engine, CLI, `voss serve`, the protocol, and the SDKs; the ADE
owns terminals, panes, canvas, layouts, and themes, and integrates only over
the protocol. See `docs/architecture/0004-voss-ade-repository-split.md`. The
frozen app and its A-track/E5/V11/V14/V24 planning history live under
`archive/voss-ade/`.
